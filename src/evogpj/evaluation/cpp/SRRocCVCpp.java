 ...
 * @author Owen Derby
 */
public class SRRocCVCpp extends FitnessFunction {

	// defaults to SR_DATA_FITNESS
	public static String FITNESS_KEY = Parameters.Operators.SR_CPP_ROC_CV;
	...
	public void evaluatePopulationCPU(Population pop, int numberOfThreads)throws IOException {
		...
		GenerateSRRocCVCpp groccv = new GenerateSRRocCVCpp(cppFile);
