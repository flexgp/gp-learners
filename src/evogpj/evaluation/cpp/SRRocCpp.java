 ...
 * @author Owen Derby
 */
public class SRRocCpp extends FitnessFunction {

	private final boolean USE_INT;

	// defaults to SR_DATA_FITNESS
	public static String FITNESS_KEY = Parameters.Operators.SR_CPP_ROC;
	...
	public SRRocCpp(List<String> aFUNC_SET,
	...
	public void evalPop(Population pop) {
		try {
			...
			Logger.getLogger(SRRocCpp.class.getName()).log(
	...
	public void evaluatePopulationCPU(Population pop, boolean useInts, int p, int numberOfThreads)throws IOException {
		...
		GenerateSRRocCpp groc = new GenerateSRRocCpp(cppFile);
		...
		startTime = System.currentTimeMillis();
		ArrayList<Float> fitnessArrayList = groc.readResults();
