 ...
 * @author nacho
 */
public class GenerateSRCorrelationCuda{
    
    Expression[] expressions;
    FileWriter fw;
    String filename;
    
    public GenerateSRCorrelationCuda(String aFileName) throws IOException{
        expressions = null;
        filename = aFileName;
    } 
	...
	fw.append("\tcudaMalloc((void**) &d_target, mem_size_fitness);\n");
        fw.append("\n");
	...
	fw.append("\tcudaMemcpy(d_target,d_dataset+targetOffset,mem_size_fitness,cudaMemcpyDeviceToDevice);\n");
	...
	fw.append("\tdim3 gridRed(num_blocks_red);\n");
        ...
        fw.append("\tssname << " + '"' + "tempFiles/resultsSRCorrelationCuda" + '"' + "<<" + '"' + ".txt" + '"' + " ;\n");
	...
	fw.append("\t\toutput << " + '"' + "FitnessIndividual " + '"' +" << (indexIndi+1) <<" + '"' + ": " + '"' + " << finalFitness << endl;\n");
        fw.append("\t}\n");
	fw.append("\n"); 
    ...
    public ArrayList<Float> readResults() throws FileNotFoundException{
        String fileOutput = "tempFiles/resultsSRCorrelationCuda.txt";
