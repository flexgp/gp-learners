...
import evogpj.evaluation.cuda.GenerateSRCudaDual;
 ...
 * @author Owen Derby
 */
public class SRCudaDual extends FitnessFunction {

	private final boolean USE_INT;

	// defaults to SR_DATA_FITNESS
	public static String FITNESS_KEY = Parameters.Operators.SR_CUDA_FITNESS_DUAL;
	...
	int numberOfFitnessCases, numberOfFeatures, numberOfResults,currentMaxSize, pow, numberOfThreads,maxIndSize;
        GenerateSRCudaDual gcudaI;
        String binCUDA = "tempFiles/SRCudaDual";
        String fileCodedRPN = "tempFiles/individualsCodedRPN.txt";
        String cuFile = "tempFiles/SRCudaDual.cu";
        
        
	public SRCudaDual(List<String> aFUNC_SET,
		...
		numberOfThreads = aNumberOfThreads;
                ...
                gcudaI = new GenerateSRCudaDual(cuFile);
	}
	...
	public void evalPop(Population pop) {
		try {
                    ...
                    Logger.getLogger(SRCudaDual.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
