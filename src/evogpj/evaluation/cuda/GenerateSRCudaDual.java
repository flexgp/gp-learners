 ...
 * @author nacho
 */
public class GenerateSRCudaDual{
    
    Expression[] expressions;
    FileWriter fw;
    String filename;
    
    public GenerateSRCudaDual(String aFileName) throws IOException{
        expressions = null;
        filename = aFileName;
    } 
	...
	fw.append("\n");
        ...
        //fw.append("unsigned int mem_size_inter;\n");
	...
	fw.append("\t}\n");
	//fw.append("cout << \"Thread \" << threadId << \" running on GPU \" << deviceId << endl;\n");
	...
	//fw.append("\t\t\toutput << " + '"' + "FitnessIndividual " + '"' +" << (indexIndi+1) <<" + '"' + ": " + '"' + " << fitness << endl;\n");
        fw.append("\t\t\th_fitness[indexIndi] = fitness;\n");
        fw.append("\t\t}\n");
        fw.append("\t}\n");
	fw.append("\n");         
	...
	fw.append("\tpthread_join(tid4, NULL);\n");
        ...
        fw.append("\tssname << " + '"' + "tempFiles/resultsSRCudaDual" + '"' + "<<" + '"' + ".txt" + '"' + " ;\n");
    ...
    public ArrayList<Float> readResults() throws FileNotFoundException{
        String fileOutput = "tempFiles/resultsSRCudaDual.txt";
