 ...
 * @author Owen Derby
 */
public class SRRocCVCuda extends FitnessFunction {


    public static String FITNESS_KEY = Parameters.Operators.SR_CUDA_ROC_CV;
    ...
    GenerateSRRocCVCuda gcudaROCCV;
    ...
    public SRRocCVCuda(List<String> aFUNC_SET,
        ...
        gcudaROCCV = new GenerateSRRocCVCuda(cuFile);
        fpWeight = afpWeight;
        fnweight = afnWeight;
    ...
    public void evalPop(Population pop) {
        try {
            ...
            Logger.getLogger(SRRocCVCuda.class.getName()).log(Level.SEVERE, null, ex);
        }
    }        
