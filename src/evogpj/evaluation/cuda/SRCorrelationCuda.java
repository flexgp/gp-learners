...
import evogpj.evaluation.cuda.GenerateSRCorrelationCuda;
 ...
 * @author Owen Derby
 */
public class SRCorrelationCuda extends FitnessFunction {

    private final boolean USE_INT;

    // defaults to SR_DATA_FITNESS
    public static String FITNESS_KEY = Parameters.Operators.SR_CUDA_FITNESS_CORRELATION;
    ...
    GenerateSRCorrelationCuda gcudaI;
    String binCUDA = "tempFiles/SRCorrCuda";
    String fileCodedRPN = "tempFiles/individualsCodedRPN.txt";
    String cuFile = "tempFiles/SRCorrCuda.cu";
        
    public SRCorrelationCuda(List<String> aFUNC_SET,
        ...
        gcudaI = new GenerateSRCorrelationCuda(cuFile);
    }
    ...
    public void evalPop(Population pop) {
            try {
                ...
                Logger.getLogger(SRCorrelationCuda.class.getName()).log(Level.SEVERE, null, ex);
            }
    }
