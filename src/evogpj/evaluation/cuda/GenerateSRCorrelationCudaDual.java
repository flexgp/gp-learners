 ...
 * @author nacho
 */
public class GenerateSRCorrelationCudaDual{
    
    Expression[] expressions;
    FileWriter fw;
    String filename;
    
    public GenerateSRCorrelationCudaDual(String aFileName) throws IOException{
        expressions = null;
        filename = aFileName;
    } 
	...
	fw.append("\n");
	fw.append("float* d_dataset1;\n");
        fw.append("float* d_dataset2;\n");
        fw.append("float* d_target1;\n");
        fw.append("float* d_target2;\n");
        fw.append("float* h_fitness;\n");
        fw.append("int* h_individuals; \n");
        fw.append("int numberOfVars, numberOfPoints,numberOfResults,maxIndividualSize,numberOfIndividuals,numGPUs,numThreads,p;\n");
        fw.append("float minTarget,maxTarget;\n");
        fw.append("bool COERCE_INT;\n");
        fw.append("typedef struct{\n");
        fw.append("\tint threadId;\n");
        fw.append("\tcudaStream_t stream;\n");
        fw.append("} ThreadParams;\n");
	...
	fw.append("\n");
        ...
        fw.append("__global__ void reduce_step_1d_sum_vectorsMeans(float* xVector, float meanX, float* yVector, float meanY, float *inter,int numberOfPoints){\n");
	fw.append("\t__shared__ float as[512];\n");
	fw.append("\tint bx = blockIdx.x;\n");
	fw.append("\tint tx = threadIdx.x;\n");
	fw.append("\tint ind = bx * blockDim.x + tx;\n");
	...
	fw.append("\tif(ind<numberOfPoints){\n");
	fw.append("\t\t//as[tx]=input[ind];\n");
	fw.append("\t\tfloat xi = xVector[ind];\n");
	fw.append("\t\tfloat yi = yVector[ind];\n");
	fw.append("\t\tas[tx] = (xi - meanX) * (yi - meanY);\n");
	fw.append("\t\t__syncthreads();\n");
	fw.append("\t}else{\n");
	fw.append("\t\tas[tx]=0;\n");
	fw.append("\t\t__syncthreads();\n");
	...
	fw.append("__global__ void reduce_step_1d_sq_diff_sum(float* xVector, float meanX, float *inter,int numberOfPoints){\n");
	fw.append("\t__shared__ float as[512];\n");
	fw.append("\tint bx = blockIdx.x;\n");
	fw.append("\tint tx = threadIdx.x;\n");
	fw.append("\tint ind = bx * blockDim.x + tx;\n");
	...
	fw.append("\tif(ind<numberOfPoints){\n");
	fw.append("\t\tfloat xi = xVector[ind];\n");
	fw.append("\t\tfloat diff = fabs(xi - meanX);\n");
	fw.append("\t\tas[tx] = powf(diff,2);\n");
	fw.append("\t\t__syncthreads();\n");
	fw.append("\t}else{\n");
	fw.append("\t\tas[tx]=0;\n");
	fw.append("\t\t__syncthreads();\n");
	...
	fw.append("\n");
        ...
        fw.append("inline float corrToFitness(float corr) {\n");
	fw.append("\tif (isnan(corr) || isinf(corr) || corr < 0.0 || corr >= 1.0) {\n");
	fw.append("\t\treturn 0.0;\n");
	fw.append("\t} else {\n");
        fw.append("\t\treturn corr;\n");
	fw.append("\t}\n");
        fw.append("}\n");
        fw.append("\n");
    ...
    private void generateThreadCode(int numberOfIndividuals,int numberOfLines,int numberOfVars,int numberOfResults,int maxIndividualSize,String filePathIndividuals, boolean COERCE_INT,int p) throws IOException{
        fw.append("void *taskThread(void *arg){\n");
	fw.append("\tThreadParams *params = (ThreadParams *)arg;\n");
	fw.append("\tint threadId = params->threadId;\n");
	...
	fw.append("\tint deviceId = threadId % numGPUs;\n");
	fw.append("\tcudaSetDevice(deviceId);\n");
	fw.append("\tfloat* d_dataset;\n");
	fw.append("\tfloat* d_target;\t\n");
	fw.append("\tif(deviceId==0){\n");
	fw.append("\t\td_dataset = d_dataset1;\n");
	fw.append("\t\td_target = d_target1;\n");
	fw.append("\t}else{\n");
	fw.append("\t\td_dataset = d_dataset2;\n");
	fw.append("\t\td_target = d_target2;\n");
	fw.append("\t}\n");
	...
	fw.append("\n");
	fw.append("\tfloat sumTargets = 0;\n");
	fw.append("\treduce_step_1d_sum<<<gridRed,threadsRed>>>(d_target, d_inter, numberOfPoints);\n");
	...
	fw.append("\t\tsumTargets += h_inter[i];\n");
	fw.append("\t}\n");
	fw.append("\tfloat meanTarget = sumTargets / (float) numberOfPoints;\n");
	fw.append("\n");
	fw.append("\tint indToCompute=numberOfIndividuals/numThreads;\n");
	fw.append("\tint startIndex =threadId*indToCompute;\n");
	fw.append("\tint endIndex =(threadId+1)*indToCompute -1;\n");
	fw.append("\n");
	fw.append("\tfor(int indexIndi=0; indexIndi<numberOfIndividuals;indexIndi++){\n");
	fw.append("\t\tif(indexIndi>=startIndex && indexIndi <=endIndex){\n");
	...
	fw.append("\t\t\t}\n");
	fw.append("\n");
	fw.append("\t\t\tfloat sumPredictions = 0;\n");
	fw.append("\t\t\treduce_step_1d_sum<<<gridRed,threadsRed>>>(d_fitness, d_inter, numberOfPoints);\n");
	fw.append("\t\t\tcudaThreadSynchronize();\n");
	fw.append("\t\t\tcudaMemcpy(h_inter, d_inter, mem_size_inter, cudaMemcpyDeviceToHost);\n");
	fw.append("\t\t\tfor(int i=0;i<num_blocks_red;i++){\n");
	fw.append("\t\t\t\tsumPredictions += h_inter[i];\n");
	fw.append("\t\t\t}\n");
	fw.append("\t\t\tfloat meanPredictions = sumPredictions / (float) numberOfPoints;\n");
	fw.append("\t\t\n");
	fw.append("\n");
	fw.append("\t\t\tfloat numerator = 0;\n");
	fw.append("\t\t\treduce_step_1d_sum_vectorsMeans<<<gridRed,threadsRed>>>(d_fitness, meanPredictions, d_target, meanTarget, d_inter, numberOfPoints);\n");
	fw.append("\t\t\tcudaThreadSynchronize();\n");
	fw.append("\t\t\tcudaMemcpy(h_inter, d_inter, mem_size_inter, cudaMemcpyDeviceToHost);\n");
	fw.append("\t\t\tfor(int i=0;i<num_blocks_red;i++){\n");
	fw.append("\t\t\t\tnumerator += h_inter[i];\n");
	fw.append("\t\t\t}\n");
	fw.append("\n");
	fw.append("\t\t\tfloat sqDiffSumPreds = 0;\n");
	fw.append("\t\t\treduce_step_1d_sq_diff_sum<<<gridRed,threadsRed>>>(d_fitness, meanPredictions,d_inter, numberOfPoints);\n");
	fw.append("\t\t\tcudaThreadSynchronize();\n");
	fw.append("\t\t\tcudaMemcpy(h_inter, d_inter, mem_size_inter, cudaMemcpyDeviceToHost);\n");
	fw.append("\t\t\tfor(int i=0;i<num_blocks_red;i++){\n");
	fw.append("\t\t\t\tsqDiffSumPreds += h_inter[i];\n");
	fw.append("\t\t\t}\n");
	fw.append("\n");
	fw.append("\t\t\tfloat sqDiffSumTargets = 0;\n");
	fw.append("\t\t\treduce_step_1d_sq_diff_sum<<<gridRed,threadsRed>>>(d_target, meanTarget,d_inter, numberOfPoints);\n");
	fw.append("\t\t\tcudaThreadSynchronize();\n");
	fw.append("\t\t\tcudaMemcpy(h_inter, d_inter, mem_size_inter, cudaMemcpyDeviceToHost);\n");
	fw.append("\t\t\tfor(int i=0;i<num_blocks_red;i++){\n");
	fw.append("\t\t\t\tsqDiffSumTargets += h_inter[i];\n");
	fw.append("\t\t\t}\n");
	fw.append("\n");
	fw.append("\t\t\tfloat denominator = sqrt(sqDiffSumPreds) * sqrt(sqDiffSumTargets);\n");
	fw.append("\t\t\tfloat corr = fabs(numerator / denominator);\n");
	fw.append("\t\t\tfloat finalFitness = corrToFitness(corr);\n");
	fw.append("\t\t\th_fitness[indexIndi] = finalFitness;\n");
	fw.append("\t\t}\n");
	fw.append("\t}\n");
	...
	fw.append("\tnumberOfPoints = " + numberOfLines + ";\n");
        fw.append("\tnumberOfVars = " + numberOfVars + ";\n");
        fw.append("\tnumberOfResults = " +numberOfResults + ";\n");
        fw.append("\tmaxIndividualSize = " + maxIndividualSize + ";\n");
        fw.append("\tnumberOfIndividuals = aNumIndividuals;\n");
        fw.append("\tnumGPUs = 2;\n");
	fw.append("\tnumThreads = 4;\n");
        fw.append("\n");
	fw.append("\tCOERCE_INT = " + COERCE_INT + ";\n");
	fw.append("\tp = " + p + ";\n");
        fw.append("\n");
	...
	fw.append("\th_individuals = (int*) malloc(mem_size_individuals);\n");
	fw.append("\n");
	fw.append("\tunsigned int size_fitness = numberOfPoints;\n");
	fw.append("\tunsigned int mem_size_fitness = sizeof(float) * size_fitness;\n");
	fw.append("\th_fitness = (float*) malloc(mem_size_fitness);\n");
	fw.append("\n");
	fw.append("\tstring filePathIndividuals = \"tempFiles/individualsCodedRPN.txt\";\n");
	...
	fw.append("\tint targetOffset = numberOfPoints * numberOfVars;\n");
	fw.append("\tcudaSetDevice(0);\n");
	fw.append("\tcudaMalloc((void**) &d_dataset1, mem_size_dataset);\n");
	fw.append("\tcudaMalloc((void**) &d_target1, mem_size_fitness);\n");
	fw.append("\tcudaMemcpy(d_dataset1, sm_dataset, mem_size_dataset,cudaMemcpyHostToDevice);\n");
	fw.append("\tcudaMemcpy(d_target1,d_dataset1+targetOffset,mem_size_fitness,cudaMemcpyDeviceToDevice);\n");
	fw.append("\tcudaSetDevice(1);\n");
	fw.append("\tcudaMalloc((void**) &d_dataset2, mem_size_dataset);\n");
	fw.append("\tcudaMalloc((void**) &d_target2, mem_size_fitness);\n");
	fw.append("\tcudaMemcpy(d_dataset2, sm_dataset, mem_size_dataset,cudaMemcpyHostToDevice);\n");
	fw.append("\tcudaMemcpy(d_target2,d_dataset2+targetOffset,mem_size_fitness,cudaMemcpyDeviceToDevice);\n");
	fw.append("\n");
	fw.append("\n");
	fw.append("\tpthread_t tid1, tid2, tid3, tid4;\n");
	fw.append("\tThreadParams thread1Params;\n");
	fw.append("\tthread1Params.threadId=0;\n");
	fw.append("\tThreadParams thread2Params;\n");
	fw.append("\tthread2Params.threadId=1;\n");
	fw.append("\tThreadParams thread3Params;\n");
	fw.append("\tthread3Params.threadId=2;\n");
	fw.append("\tThreadParams thread4Params;\n");
	fw.append("\tthread4Params.threadId=3;\n");
	fw.append("\tpthread_create(&tid1, NULL, taskThread,  (void *) &thread1Params);\n");
	fw.append("\tpthread_create(&tid2, NULL, taskThread, (void *) &thread2Params);\n");
	fw.append("\tpthread_create(&tid3, NULL, taskThread, (void *) &thread3Params);\n");
	fw.append("\tpthread_create(&tid4, NULL, taskThread, (void *) &thread4Params);\n");
	fw.append("\tpthread_join(tid1, NULL);\n");
	fw.append("\tpthread_join(tid2, NULL);\n");
	fw.append("\tpthread_join(tid3, NULL);\n");
	fw.append("\tpthread_join(tid4, NULL);\n");
	fw.append("\tstringstream output;\n");
	fw.append("\tofstream outFile;\n");
	fw.append("\tstring name=\"\";\n");
	fw.append("\tstringstream ssname;\n");
	fw.append("\tssname << \"tempFiles/resultsSRCorrCudaDual\"<<\".txt\" ;\n");
	fw.append("\tname = ssname.str();\n");
	fw.append("\toutFile.open(name.c_str());\n");
	fw.append("\n");
	fw.append("\tfor(int i=0;i<numberOfIndividuals;i++){\n");
	fw.append("\t\toutput << \"ErrorIndividual \" << (i+1) << \": \" << h_fitness[i] << endl;\n");
	fw.append("\t}\n");
	...
	fw.append("\n");
	fw.append("\tcudaFree(d_dataset1);\n");
	fw.append("\tcudaFree(d_dataset2);\n");
	fw.append("\tcudaFree(d_target1);\n");
	fw.append("\tcudaFree(d_target2);\n");
    ...
    public void generateCode(int numberOfIndividuals,int numberOfLines,int numberOfVars,int numberOfResults,int maxIndividualSize,String filePathIndividuals,boolean COERCE_INT,int p) throws IOException{
        ...
        generateThreadCode(numberOfIndividuals,numberOfLines,numberOfVars,numberOfResults,maxIndividualSize,filePathIndividuals,COERCE_INT,p);
    ...
    public ArrayList<Float> readResults() throws FileNotFoundException{
        String fileOutput = "tempFiles/resultsSRCorrCudaDual.txt";
