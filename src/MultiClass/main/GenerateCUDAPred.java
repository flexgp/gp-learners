 ...
 * @author nacho
 */
public class GenerateCUDAPred{
    
    Expression[] expressions;
    FileWriter fw;
    String filename;
    
    public GenerateCUDAPred(String aFileName) throws IOException{
        expressions = null;
        filename = aFileName;
    } 
	...
	fw.append("\tdim3 gridRed(num_blocks_red);\n");
        ...
        fw.append("\tssname << " + '"' + "resultsCUDAROC" + '"' + "<<" + '"' + ".txt" + '"' + " ;\n");
	...
	fw.append("\n");
        ...
        fw.append("\t\t}\n");
	fw.append("\t\toutput << " + '"' + "FitnessIndividual " + '"' +" << (indexIndi+1) <<" + '"' + ": " + '"' + " << totalArea << endl;\n");
        fw.append("\t}\n");
	fw.append("\n"); 
    ...
    public void generateCode(int numberOfIndividuals,int numberOfLines,int numberOfVars,int numberOfResults,int maxIndividualSize,String filePathIndividuals) throws IOException{
    ...
    public ArrayList<Float> readResults() throws FileNotFoundException{
        String fileOutput = "resultsCUDAROC.txt";
